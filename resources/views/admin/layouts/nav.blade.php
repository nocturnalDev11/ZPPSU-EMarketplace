...
<body>
    <div id="app">
        <div>
            <nav class="flex flex-wrap items-center justify-between backdrop-filter backdrop-blur-lg bg-opacity-40 bg-white fixed left-0 right-0 top-0 sm:px-10 px-6 py-1 lg:gap-y-4 gap-y-6 gap-x-4  z-[200] w-full dark:bg-gray-900 dark:backdrop:filter dark:backdrop-blur-4xl dark:bg-opacity-70">
                <div class="flex">
                    <button id="toggleOpen">
                        <svg class="w-7 h-7 fill-[#333] dark:fill-[#fff]" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path>
                        </svg>
                    </button>
                    <h1 class="text-2xl font-bold ml-8 w-36 text-[#333] dark:text-[#fff]">
                        Admin Panel
                    </h1>
                </div>
                ...
                <div class='flex items-center space-x-8 max-md:ml-auto'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" class="cursor-pointer fill-[#333] dark:fill-[#fff] hover:fill-[#077bff]" viewBox="0 0 371.263 371.263">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" class="cursor-pointer fill-[#333] dark:fill-[#fff] hover:fill-[#077bff]" viewBox="0 0 512 512">
            ...
            <div class="bg-white h-screen fixed top-0 left-0 w-80 pt-[70px] px-4 font-[sans-serif] flex flex-col overflow-auto flex-none dark:bg-gray-900">
                ...
                <ul class="space-y-3 mt-8">
                    <li>
                        <a href="{{ route('admin.dashboard') }}" wire:navigate class="text-gray-700 text-sm flex items-center dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-900 rounded px-4 py-3 transition-all">
                    ...
                    <li>
                        <a href="{{ route('all.users') }}" wire:navigate class="text-gray-700 text-sm flex items-center dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-900 rounded px-4 py-3 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] h-[18px] mr-4" viewBox="0 0 512 512">
                    ...
                    {{-- <li>
                        <a href="javascript:void(0)" class="text-gray-700 text-sm flex items-center dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-900 rounded px-4 py-3 transition-all">
                    ...
                    {{-- <li>
                        <a href="javascript:void(0)" class="text-gray-700 text-sm flex items-center dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-900 rounded px-4 py-3 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] h-[18px] mr-4" viewBox="0 0 371.263 371.263">
