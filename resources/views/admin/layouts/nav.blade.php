...
<body x-data="sidebar()" class="antialiased" @resize.window="handleResize()">
    <div class="xl:flex">
        ...
        <aside
            ...
            x-show="isOpen()"
            class="fixed xl:static inset-0 flex bg-white bg-opacity-75 h-screen z-40">
            <div @click.away="handleAway()" class="w-full xl:w-80 text-gray-800 bg-white shadow top-0 left-0">
                ...
                <ul class="space-y-2 mt-8 mx-2">
                    ...
                    <li x-data="{ expanded: false }">
                        <button @click="expanded = ! expanded" type="button" class="flex items-center w-full px-4 py-3 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
                        ...
                        <div x-show="expanded" x-collapse>
                            <ul class="py-2 space-y-2">
                                <li>
                                   <a href="{{ route('all.users') }}" wire:navigate class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">All users</a>
                                </li>
                                <li>
