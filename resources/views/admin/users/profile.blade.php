                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('admin.users.list') }}" wire:navigate class="ml-1 text-sm font-medium text-gray-400 md:ml-2" aria-current="page">Users</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="ml-1 md:ml-2 text-sm font-medium text-gray-700 hover:text-gray-900">View user</a>
                                </div>
                            </li>
                        </ol>
                    </nav>
