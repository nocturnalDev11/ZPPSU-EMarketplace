...
<head>
    ...
    <title>
        @if (Route::currentRouteName() == 'register')
            ZPPSU E-Market | Register
        @elseif (Route::currentRouteName() == 'login')
            ZPPSU E-Market | Login
        @else
            ZPPSU E-Market
        @endif
    </title>
...
<body>
    <div id="app">
        <nav class="backdrop-filter backdrop-blur-lg bg-opacity-40 bg-white border-b border-gray-200 fixed left-0 right-0 top-0 z-50 dark:bg-gray-600 dark:backdrop:filter dark:backdrop-blur-lg dark:bg-opacity-40 dark:border-gray-500">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-2">
                ...
                <div class="flex md:order-2">
                    ...
                    <div>
                        @if (Route::currentRouteName() == 'register')
                            <a class="px-4 py-2 bg-gradient-to-br from-red-600 to-orange-400 hover:bg-gradient-to-bl text-gray-50 rounded-xl flex items-center justify-center gap-2" href="{{ route('login') }}" wire:navigate>
                        ...
                        @elseif (Route::currentRouteName() == 'login')
                            <a class="px-4 py-2 bg-gradient-to-br from-red-600 to-orange-400 hover:bg-gradient-to-bl text-gray-50 rounded-xl flex items-center justify-center gap-2" href="{{ route('register') }}" wire:navigate>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M3 3a1 1 0 011 1v12a1 1 0 11-2 0V4a1 1 0 011-1zm7.707 3.293a1 1 0 010 1.414L9.414 9H17a1 1 0 110 2H9.414l1.293 1.293a1 1 0 01-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0z" clip-rule="evenodd" />
                                </svg>
                ...
                {{-- <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    <ul class="flex flex-col p-0 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:border-0">
                        <li class="flex flex-col items-center justify-center">
                            <button class="flex items-center justify-center p-3 w-full h-10 text-lg text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-300 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-current="page">
                                About
                            </button>
                        </li>
                        <li>
                            <button class="flex items-center justify-center p-3 w-full h-10 text-lg text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-300 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                                FAQ
                            </button>
                        </li>
                        <li>
