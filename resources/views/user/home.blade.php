...
@section('content')
    ...
    <div data-dial-init class="fixed bottom-6 end-24 group">
        @php
            $baseClasses = 'flex flex-col items-center mb-4 space-y-2';
            $additionalClasses = 'hidden';
            $allClasses = $baseClasses . ' ' . $additionalClasses;
        @endphp
        <div id="speed-dial-menu-text-outside-button-square" class="{{ $allClasses }}">
            <!-- Product button -->
            <button type="button" data-tooltip-target="tooltip-product" data-tooltip-placement="left" data-modal-target="product-modal" data-modal-toggle="product-modal" class="relative w-[52px] h-[52px] text-gray-500 bg-gray-100 rounded-full border border-gray-200 hover:text-gray-900 shadow-sm hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 focus:outline-none">
                <svg class="w-6 h-6 mx-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path fill-rule="evenodd" d="M7.5 6v.75H5.513c-.96 0-1.764.724-1.865 1.679l-1.263 12A1.875 1.875 0 0 0 4.25 22.5h15.5a1.875 1.875 0 0 0 1.865-2.071l-1.263-12a1.875 1.875 0 0 0-1.865-1.679H16.5V6a4.5 4.5 0 1 0-9 0ZM12 3a3 3 0 0 0-3 3v.75h6V6a3 3 0 0 0-3-3Zm-3 8.25a3 3 0 1 0 6 0v-.75a.75.75 0 0 1 1.5 0v.75a4.5 4.5 0 1 1-9 0v-.75a.75.75 0 0 1 1.5 0v.75Z" clip-rule="evenodd" />
                </svg>
            </button>
            <!-- Tooltip -->
            <div id="tooltip-product" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                Product
                <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
            <!-- Post button -->
            <button type="button" data-tooltip-target="tooltip-post" data-tooltip-placement="left" data-modal-target="post-modal" data-modal-toggle="post-modal" class="relative w-[52px] h-[52px] text-gray-500 bg-gray-100 rounded-full border border-gray-200 hover:text-gray-900 shadow-sm hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 focus:outline-none">
                <svg class="w-6 h-6 mx-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path fill-rule="evenodd" d="M2 6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6Zm4.996 2a1 1 0 0 0 0 2h.01a1 1 0 1 0 0-2h-.01ZM11 8a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2h-6Zm-4.004 3a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2h-.01ZM11 11a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2h-6Zm-4.004 3a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2h-.01ZM11 14a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2h-6Z" clip-rule="evenodd"/>
                </svg>
            </button>
            <!-- Tooltip -->
            <div id="tooltip-post" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                Post
                <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
            <!-- Service button -->
            <button type="button" data-tooltip-target="tooltip-service" data-tooltip-placement="left" data-modal-target="service-modal" data-modal-toggle="service-modal" class="relative w-[52px] h-[52px] text-gray-500 bg-gray-100 rounded-full border border-gray-200 hover:text-gray-900 shadow-sm hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 focus:outline-none">
                <svg class="w-6 h-6 mx-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path fill-rule="evenodd" d="M12 2a7 7 0 0 0-7 7 3 3 0 0 0-3 3v2a3 3 0 0 0 3 3h1a1 1 0 0 0 1-1V9a5 5 0 1 1 10 0v7.083A2.919 2.919 0 0 1 14.083 19H14a2 2 0 0 0-2-2h-1a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h1a2 2 0 0 0 1.732-1h.351a4.917 4.917 0 0 0 4.83-4H19a3 3 0 0 0 3-3v-2a3 3 0 0 0-3-3 7 7 0 0 0-7-7Zm1.45 3.275a4 4 0 0 0-4.352.976 1 1 0 0 0 1.452 1.376 2.001 2.001 0 0 1 2.836-.067 1 1 0 1 0 1.386-1.442 4 4 0 0 0-1.321-.843Z" clip-rule="evenodd"/>
                </svg>
            </button>
            <!-- Tooltip -->
            <div id="tooltip-service" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                Service
                <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
            <!-- Trading button -->
            <button type="button" data-tooltip-target="tooltip-trade" data-tooltip-placement="left" data-modal-target="trade-modal" data-modal-toggle="trade-modal" class="relative w-[52px] h-[52px] text-gray-500 bg-gray-100 rounded-full border border-gray-200 hover:text-gray-900 shadow-sm hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 focus:outline-none">
                <svg class="w-6 h-6 mx-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <!-- Tooltip -->
            <div id="tooltip-trade" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                Trading
                <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
        </div>
        <button type="button" data-dial-toggle="speed-dial-menu-text-outside-button-square" data-dial-trigger="click" aria-controls="speed-dial-menu-text-outside-button-square" aria-expanded="false" class="flex items-center justify-center text-white rounded-full w-14 h-14 bg-gradient-to-br from-red-500 to-orange-400 hover:bg-gradient-to-bl focus:outline-none">
            <svg class="w-6 h-6 transition-transform group-hover:rotate-45" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
