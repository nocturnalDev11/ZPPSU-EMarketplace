...
@section('content')
    @include('user.upload-profile-modal')
    @include('lists.modals.create-modal')
    @include('messages.send-mesage')
    ...
    <div class="xl:ml-80 lg:ml-80 md:ml-0 ml-0 bg-gray-100 dark:bg-gray-800 font-sans pb-10">
        ...
        <main class="{{ $allClasses }}">
            <aside class="mt-24">
                <div class="bg-white shadow rounded-lg p-10 dark:bg-gray-700">
                    <div class="flex flex-col gap-1 text-center items-center">
                        <div class="relative inline-flex items-center">
                            <img src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('storage/profile_pictures/profile-placeholder.jpg') }}" class="h-32 w-32 bg-white p-2 rounded-full shadow mb-4 dark:bg-gray-500 object-cover bg-center" alt="">
                        </div>
                        <p class="text-2xl font-semibold text-gray-700 dark:text-white">
                            {{ $user->first_name }}
                            {{ $user->last_name }}
                        </p>
                        <div class="text-lg leading-normal text-gray-400 dark:text-white flex justify-center items-center space-x-3">
                    ...
                    <div class="flex flex-col">
                        @can('update', $user)
                            <a href="{{ route('user.settings') }}"  type="button" class="text-white bg-gradient-to-r from-red-700 to-yellow-500 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-maroon font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2">
                                Edit profile
                            </a>
                        @endcan
                        @can('message', $user)
                            <button data-modal-target="message-modal" data-modal-toggle="message-modal" type="button" class="text-white bg-gradient-to-r from-red-700 to-yellow-500 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-maroon font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2">
                                Message
                            </button>
                        @endcan
                    </div>
