    ...
    <section class="pt-48 h-screen dark:bg-gray-900">
        <div class="container flex flex-col justify-center mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
            <div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left dark:text-gray-300">
                ...
                >
                    <button @click="modelOpen =!modelOpen" class="px-8 py-3 text-lg font-semibold rounded bg-gradient-to-br from-red-600 to-orange-400 hover:bg-gradient-to-bl text-gray-100">
                        Get started
                    </button>
                    ...
                    <div x-show="modelOpen" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                            ...
                            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                                ...
                                class="inline-block p-5 my-auto sm:my-24 overflow-hidden text-left transition-all transform bg-white rounded-lg w-1/4 shadow-xl">

                                <div class="flex items-center justify-end">
                                    {{-- <h1 class="text-xl font-medium text-gray-800 ">Enter email</h1> --}}
                                ...
                                <form action="{{ route('send.credentials') }}" method="POST"
                                    ...
                                    <div class="w-full md:mt-0">
                                        ...
                                        <p class="mb-4 text-md text-gray-800">Please enter the email address below. We will send your account credentials to this email. Use this as you log in.</p>
