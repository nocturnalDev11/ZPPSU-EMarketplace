        ...
        <div class="relative bg-white rounded-lg shadow">
            <div class="p-4 md:p-5 text-center">
                ...
                <div class="flex justify-center">
                    ...
                    <button data-modal-hide="delete-product-modal" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">
                        No, cancel
                    </button>
                </div>
            </div>
