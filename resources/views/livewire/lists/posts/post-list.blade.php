                    ...
                    <div x-show="modelOpen" class="fixed inset-0 z-[700] flex items-center justify-center" aria-labelledby="modal-title"
                        ...
                        <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                            ...
                            <div class="flex items-center justify-between space-x-4">
                                <h1 class="text-xl font-medium text-gray-800 ">Add a post</h1>
                            ...
                            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div x-data="{ photoName: null, photoPreview: null }"
                                    class="col-span-6 ml-2 sm:col-span-4 ">
                                ...
                                <div class="xl:w-3/5 lg:w-3/5 md:w-full w-full xl:px-12 lg:px-10 md:px-6 px-6 md:mt-0">
                                    <div class="grid gap-2 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            ...
                                            <input id="post_title" name="post_title" placeholder="Ex. LF apparel"
                                                type="text"
                                                class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                        </div>

                                        <div class="col-span-2">
                                            <label for="post_list_type"
                                                class="block text-sm text-gray-700 dark:text-gray-200">Post list
                                                type</label>
