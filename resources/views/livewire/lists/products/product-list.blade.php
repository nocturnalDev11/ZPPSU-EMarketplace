<div x-data="{
    ...
    <div
        class="flex xl:flex-row lg:flex-col md:flex-col flex-col items-center justify-between p-4 space-y-3 md:space-y-2 md:space-x-4">
        <!-- Search -->
        ...
        <div
            ...
            <div x-data="{ modelOpen: false }">
                ...
                <div x-show="modelOpen" class="fixed inset-0 z-[700] overflow-y-auto" aria-labelledby="modal-title"
                        ...
                        <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                            ...
                            <form action="{{ route('product.store') }}" method="POST" class="mt-5"
                                ...
                                <div x-data="{ photoName: null, photoPreview: null }"
                                    ...
                                    <label
                                        class="block text-gray-700 text-sm font-bold mb-2 text-center dark:text-white"
                                        for="photo">
                                        Product picture
                                ...
                                <div class="grid gap-2 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        <label for="prod_name"
                                            class="block text-sm text-gray-700 dark:text-gray-200">Product
                                            name</label>
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        <label for="prod_price"
                                            class="block text-sm text-gray-700 dark:text-gray-200">Price</label>
            ...
            <div
                ...
                <div class="relative">
                    <a href="{{ route('products.show', $product->id) }}" wire:navigate
                        class="block shadow-lg rounded-2xl">
                        <img src="{{ asset('storage/' . $product->prod_picture) }}" alt="{{ $product->prod_name }}"
