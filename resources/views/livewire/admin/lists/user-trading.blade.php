            ...
            <div class="justify-end items-center sm:flex gap-2 w-full">
                ...
                <div @click.away="openSort = false" class="relative">
                    ...
                    <div x-show="openSort" class="absolute mt-2 w-44 bg-white shadow rounded z-10">
                        <button wire:click="setSort('latest')" class="block w-full px-4 py-2 text-sm text-left hover:bg-gray-100">
                            Latest
                        </button>
                        <button wire:click="setSort('oldest')" class="block w-full px-4 py-2 text-sm text-left hover:bg-gray-100">
                            Oldest
                        </button>
                    </div>
                </div>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                                @forelse ($trades as $trade)
                                    <tr>
                                        <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="flex items-center gap-4">
                                                @if ($trade->trade_picture)
                                                    <img class="w-10 h-10 rounded-xl object-cover bg-center" src="{{ asset('storage/' . $trade->trade_picture) }}"
                                                ...
                                                @else
                                                    <div
                                                        ...
                                                        <svg class="p-2 text-md text-gray-700 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                                            <path
                                        ...
                                        <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-gray-400 hover:underline">
                                            <a href="{{ route('view.user', ['id' => $trade->user->id]) }}" wire:navigate>
                                                {{ $trade->user->first_name }} {{ $trade->user->last_name }}
                                            </a>
                                        </td>
                                        <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-gray-400">
                                            {{ $trade->created_at->format('F j, Y') }}
                                        </td>
                                                        ...
                                                        <div x-show="modelOpen" class="fixed inset-0 z-50 flex items-center justify-center"
                                                            ...
                                                            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                                                                ...
                                                                <div class="flex p-4 gap-4">
                                                                    @if ($trade->trade_picture)
                                                                        <div class="w-28 h-28">
                                                                            <img class="w-full h-full rounded-xl object-cover bg-center"
                                                                                src="{{ asset('storage/' . $trade->trade_picture) }}"
                                                                                alt="{{ $trade->trade_title }}">
                                                                        </div>
                                                                    @else
                                                                        <div class="relative inline-flex items-center justify-center rounded-xl overflow-hidden bg-gray-200 dark:bg-gray-600 w-28 h-28">
                                                                            <svg class="p-2 text-md text-gray-700 dark:text-gray-300 w-14 h-14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                                                fill="currentColor">
                                                                                <path
                                                                                    d="M16.0503 12.0498L21 16.9996L16.0503 21.9493L14.636 20.5351L17.172 17.9988L4 17.9996V15.9996L17.172 15.9988L14.636 13.464L16.0503 12.0498ZM7.94975 2.0498L9.36396 3.46402L6.828 5.9988L20 5.99955V7.99955L6.828 7.9988L9.36396 10.5351L7.94975 11.9493L3 6.99955L7.94975 2.0498Z">
                                                                                </path>
                                                                    ...
                                                                    @endif
                                                                    <div>
                                                                        <h1 class="mb-2 text-xl font-bold text-gray-500">{{ $trade->trade_title }}</h1>
                                                                        <span
                                                                        ...
                                                                        <p class="text-sm text-gray-700 my-2">
                                                                            <span class="my-2 font-semibold">Description:</span>
                                                                            {!! nl2br(e($trade->trade_description)) !!}
                                                                        </p>
                                                                        <p class="text-sm text-gray-700">
                                                                            <span class="my-2 font-semibold">Conditions:</span>
                                                        ...
                                                        <div x-show="modelOpen" class="fixed inset-0 z-50 flex items-center justify-center"
                                                            ...
                                                            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                                                                ...
                                                                <div class="p-4 text-center">
                                                                    ...
                                                                    <h3 class="mb-5 text-lg font-normal text-gray-500">Are you sure you want to delete this trade?
                                                                    </h3>
                                                                </div>
                                                                <div class="flex justify-end pr-6">
                                                                    <form action="{{ route('delete.trades', $trade->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
