                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-white hover:underline">
                                        <a href="{{ route('view.user', ['id' => $post->user->id]) }}" wire:navigate>
                                                    ...
                                                    <div x-show="modelOpen" class="fixed inset-0 z-50 flex items-center justify-center"
                                                        ...
                                                        <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                                                            ...
                                                            <div class="flex p-4 gap-4">
                                                                ...
                                                                @endif
                                                                <div>
                                                                    <h1 class="mb-2 text-xl font-bold text-gray-500">{{ $post->post_title }}</h1>
                                                                    <span
                                                    ...
                                                    <div x-show="modelOpen" class="fixed inset-0 z-50 flex items-center justify-center"
                                                        ...
                                                        <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                                                            ...
                                                            <div class="p-4 text-center">
                                                                ...
                                                                <h3 class="mb-5 text-lg font-normal text-gray-500">Are you sure you want to delete this post?
                                                                </h3>
                                                            </div>
                                                            <div class="flex justify-end pr-6">
