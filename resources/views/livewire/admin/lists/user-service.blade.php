                ...
                <div @click.away="openStatus = false" class="relative">
                    ...
                    <div x-show="openStatus" class="absolute right-0 mt-2 w-48 p-3 bg-white shadow rounded z-10">
                        ...
                        <ul class="space-y-2 text-sm">
                            @foreach (['Available', 'Discontinued', 'Closed'] as $status)
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                                @forelse ($services as $service)
                                    <tr>
                                        <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                            <div class="flex items-center gap-4">
                                                @if ($service->services_picture)
                                                    <img class="w-10 h-10 rounded-xl object-cover bg-center" src="{{ asset('storage/' . $service->services_picture) }}"
                                                ...
                                                <div class="font-medium dark:text-white">
                                                    <div>{{ $service->services_title }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="p-4 text-sm font-normal text-green-700 whitespace-nowrap dark:text-green-500">
                                            ₱{{ $service->services_fee }}
                                        </td>
                                        <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-gray-400">
                                            <a href="{{ route('view.user', ['id' => $service->user->id]) }}" wire:navigate class="hover:underline">
                                                                ...
                                                                <div class="flex p-4 gap-4">
                                                                    ...
                                                                    <div class="w-28 h-28">
                                                                        <img class="w-full h-full rounded-xl object-cover bg-center"
                                                                            src="{{ asset('storage/' . $service->services_picture) }}" alt="{{ $service->services_title }}">
                                                                    </div>
                                                                    @else
                                                                    <div
                                                                        class="relative inline-flex items-center justify-center rounded-xl overflow-hidden bg-gray-200 dark:bg-gray-600 w-28 h-28">
                                                                    ...
                                                                    @endif
                                                                    <div>
                                                                        <h1 class="mb-2 text-xl font-bold text-gray-500">{{ $service->services_title }}</h1>
                                                                        <p class="text-md font-medium text-green-500">₱{{ $service->services_fee }}</p>
                                                                        <span
