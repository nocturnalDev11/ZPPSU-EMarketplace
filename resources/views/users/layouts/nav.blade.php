            ...
            @guest
                {{-- <div>
                    @if (Route::currentRouteName() == 'welcome')
                        <a class="my-2 px-4 py-2 bg-gradient-to-br from-red-600 to-orange-400 hover:bg-gradient-to-bl text-gray-50 rounded-xl flex items-center justify-center gap-2"
