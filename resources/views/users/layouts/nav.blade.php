...
<body class="antialiased">
    <div id="app">
        <div>
                ...
                @auth
                    ...
                    <div class='flex items-center space-x-8 max-md:ml-auto'>
                        <a href="{{ route('users.home') }}" wire:navigate class="cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" class="cursor-pointer fill-[#333] hover:fill-[#077bff]" viewBox="0 0 511 511.999">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" class="cursor-pointer fill-[#333] hover:fill-[#077bff]" viewBox="0 0 371.263 371.263">
                        ...
                        >
                            <button class="cursor-pointer" x-ref="button" x-on:click="toggle()" :aria-expanded="open" :aria-controls="$id('dropdown-button')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" class="fill-[#333] hover:fill-[#077bff]" viewBox="0 0 512 512">
            ...
            @auth
                <aside class="bg-white fixed top-0 left-0 w-80 h-screen z-[100] sm:block hidden">
