...
@section('content')
    <div class="max-w-4xl mx-auto font-[sans-serif] p-6 mt-[70px]">
        <div class="text-center mb-16">
            <h1 class="text-gray-800 text-4xl font-semibold mt-6">Sign up into your account</h4>
            <p class="text-base mt-5">Join Our Community with all-time access and free.</p>
        </div>
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input name="first_name" id="first_name" type="text" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300 @error('first_name') is-invalid @enderror" placeholder="Enter first name" required/>
                    @error('first_name')
                ...
                <div class="sm:col-span-2 flex space-x-4 w-full">
                    ...
                    <div class="w-3/4">
                        ...
                        <input name="last_name" id="last_name" type="text" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300 @error('last_name') is-invalid @enderror" placeholder="Enter last name" required/>
                        @error('last_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="w-1/4 relative" x-data="{ open: false, selected: '', suffixOptions: ['N/A', 'Jr', 'Sr'] }">
                        <label for="suffix" class="text-gray-800 text-sm mb-2 block">Suffix</label>
                        <!-- Dropdown button -->
                        <button @click="open = !open" type="button" class="w-full bg-white border border-gray-300 text-gray-800 text-sm px-4 py-3 rounded-md flex justify-between items-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300">
                            <!-- Dropdown text -->
                ...
                <!-- DOB -->
                <div>
                    <label for="dob" class="text-gray-800 text-sm mb-2 block">Birthday</label>
                    <input name="dob" id="dob" type="date" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300 @error('dob') is-invalid @enderror" placeholder="Enter first name" required/>
                    @error('dob')
                ...
                <div x-data="{ open: false, selected: '{{ old('gender', '') }}', genderOptions: ['Male', 'Female', 'Others'] }" class="relative">
                    ...
                    <!-- Dropdown button -->
                    <button @click="open = !open" type="button" class="w-full bg-white border border-gray-300 text-gray-800 text-sm px-4 py-3 rounded-md flex justify-between items-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 @error('gender') @enderror">
                        <!-- Dropdown text -->
                ...
                <div x-data="{ open: false, selected: '{{ old('role', '') }}', roleOptions: ['Student', 'Faculty', 'Staff'] }" class="relative">
                    ...
                    <!-- Dropdown button -->
                    <button @click="open = !open" type="button" class="w-full bg-white border border-gray-300 text-gray-800 text-sm px-4 py-3 rounded-md flex justify-between items-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 @error('role') @enderror">
                        <!-- Dropdown text -->
                ...
                <div x-data="{ open: false, selected: '{{ old('department', '') }}', departmentOptions: ['CICS', 'CME', 'CTE', 'CET', 'CAHSS', 'SBA', 'SHS', 'DRRMO', 'Registrar', 'Admissions Office', 'Guidance and Couseling', 'Medical-Dental Health Services', 'Learning Commons Center'] }" class="relative">
                    <label class="text-gray-800 text-sm mb-2 block">Department</label>
                    <!-- Dropdown button -->
                    <button @click="open = !open" type="button" class="w-full bg-white border border-gray-300 text-gray-800 text-sm px-4 py-3 rounded-md flex justify-between items-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 @error('department') @enderror">
                        <!-- Dropdown text -->
