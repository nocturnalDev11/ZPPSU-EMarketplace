        ...
        <div class="xl:w-full">
            <div class="bg-slate-100 shadow-md rounded-md flex flex-col items-center p-8 xl:flex-row lg:flex-row md:flex-col">
                ...
                <div class="xl:pt-0 lg:pt-0 md:pt-8 pt-8 xl:w-2/5 lg:w-2/5 md:w-full w-full">
                    <img src="{{ asset('storage/' . $product->prod_picture) }}" alt="{{ $product->prod_name }}" class="object-cover aspect-square rounded-md shadow-lg shadow-gray-300" />
                </div>
                ...
                <div class="xl:w-3/5 lg:w-3/5 md:w-full w-full xl:px-12 lg:px-10 md:px-6 px-6 md:mt-0">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">{!! nl2br(e($product->prod_description)) !!}</p>
                    </div>
                    <div class="mt-6">
                        <span class="inline-block bg-green-100 text-green-700 rounded-full px-3 py-1 text-sm font-semibold dark:bg-gray-600 dark:text-gray-300">
                        ...
                        <span class="inline-block bg-sky-100 text-sky-700 rounded-full px-3 py-1 text-sm font-semibold dark:bg-gray-600 dark:text-gray-300">
                    ...
                    <div class="my-5">
                        ...
                        @if(Auth::id() === $product->user->id)
                            <div class="inline-flex">
                                @include('users.lists.products.edit')
