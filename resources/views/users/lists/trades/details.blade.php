        ...
        <div class="xl:w-full">
            <div class="bg-slate-100 shadow-md rounded-md flex flex-col items-center p-8 xl:flex-row lg:flex-row md:flex-col">
                ...
                <div class="xl:w-3/5 lg:w-3/5 md:w-full w-full xl:px-12 lg:px-10 md:px-6 px-6 md:mt-0">
                    ...
                    <div class="mt-6">
                        <span class="m-2 inline-block bg-green-100 text-green-700 rounded-full px-3 py-1 text-sm font-semibold dark:bg-gray-600 dark:text-gray-300">
                            Status: {{ $trade->trade_status }}
                        </span>
                        <span class="m-2 inline-block bg-amber-100 text-amber-700 rounded-full px-3 py-1 text-sm font-semibold dark:bg-gray-600 dark:text-gray-300">
                            Category: {{ $trade->trade_category }}
                        </span>
                        <span class="m-2 inline-block bg-sky-100 text-blue-700 rounded-full px-3 py-1 text-sm font-semibold dark:bg-gray-600 dark:text-gray-300">
                            Type: {{ $trade->trade_type }}
                        </span>
                        <span class="m-2 inline-block bg-cyan-100 text-cyan-700 rounded-full px-3 py-1 text-sm font-semibold dark:bg-gray-600 dark:text-gray-300">
                    ...
                    <div class="my-5">
                        ...
                        @if(Auth::id() === $trade->user->id)
                            <div class="inline-flex gap-2">
                                @include('users.lists.trades.edit')
            ...
            <div
                class="container mx-auto my-6 flex flex-col px-6 py-3 min-w-0 mb-6 break-words bg-gradient-to-br from-red-50 via-purple-50 to-gray-100 border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-lg bg-clip-border">
                ...
                <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                    <div
                        class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none dark:shadow-soft-dark-lg rounded-2xl bg-clip-border">
                        @if ($relatedTrade->services_picture)
                        <div class="relative">
                            <a class="block shadow-lg rounded-2xl">
                                <img src="{{ asset('storage/' . $relatedTrade->services_picture) }}"
                                    alt="{{ $relatedTrade->services_title }}"
                        ...
                        <div class="flex-auto px-1 pt-6">
                            ...
                            <p
                                class="relative z-10 mb-2 leading-normal text-transparent bg-gradient-to-tl from-gray-900 to-gray-800 text-sm bg-clip-text dark:text-white dark:opacity-80">
