        ...
        <div x-show="modelOpen" class="fixed inset-0 z-[700] flex items-center justify-center" aria-labelledby="modal-title"
            ...
            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <div class="flex items-center justify-between space-x-4">
                    <h1 class="text-xl font-medium text-gray-800 ">Edit a post</h1>
                        ...
                        <div class="text-center">
                            ...
                            @if($post->post_picture)
                                <div x-show="!photoPreview"
                                    ...
                                    <img src="{{ asset('storage/' . $post->post_picture) }}"
                                        class="justify-center object-cover w-64 h-64 rounded-lg cursor-pointer" alt="Posts">
                                </div>
                            @else
                                <div x-show="!photoPreview"
                                    class="relative flex items-center justify-center overflow-hidden bg-cover bg-center w-80 h-80 m-auto rounded-md shadow-soft-xl">
                        ...
                        <div class="grid gap-2 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                ...
                                <input id="post_title" name="post_title" placeholder="Ex. LF apparel" type="text"
                                    ...
                                    value="{{ old('prod_name', $post->post_title) }}"
                                >
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="post_content" name="post_content" type="text"
                                    ...
                                    rows="4">{{ old('post_content', $post->post_content) }}</textarea>
                            </div>
                        </div>
