        ...
        <nav class="flex mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <a href="{{ route('lists.posts.index') }}" wire:navigate class="inline-flex items-center text-md font-medium text-gray-700 hover:text-maroon">
                ...
                <div class="xl:w-3/5 lg:w-3/5 md:w-full w-full xl:px-12 lg:px-10 md:px-6 px-6 md:mt-0">
                    ...
                    <div class="my-5">
                        ...
                        @if(Auth::id() === $post->user->id)
                            <div class="flex gap-2">
                                @include('users.lists.posts.edit')
                                @include('users.lists.posts.delete-post')
                            </div>
                        </div>
                        @endif
                    </div>
