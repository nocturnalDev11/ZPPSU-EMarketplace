                    ...
                    <nav class="flex mb-5" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2">
                            <li class="inline-flex items-center">
                                <a href="{{ route('users.home') }}" wire:navigate class="inline-flex items-center text-gray-700 hover:text-gray-900">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="ml-1 md:ml-2 text-sm font-medium text-gray-700 hover:text-gray-900">Profile</a>
                                </div>
                            </li>
                        </ol>
                    </nav>
