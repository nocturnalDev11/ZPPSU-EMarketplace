                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg h-52">
                        <div class="flex-auto p-4 flex flex-col justify-between h-full">
                            ...
                            <a href="<?php echo e(route('lists.products.index')); ?>" wire:navigate class="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                                All products
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg h-52">
                        <div class="flex-auto p-4 flex flex-col justify-between h-full">
                            ...
                            <a href="<?php echo e(route('lists.services.index')); ?>" wire:navigate class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                                All services
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg h-52">
                        <div class="flex-auto p-4 flex flex-col justify-between h-full">
                            ...
                            <a href="<?php echo e(route('lists.posts.index')); ?>" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                                All posts
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg h-52">
                        <div class="flex-auto p-4 flex flex-col justify-between h-full">
                            ...
                            <a href="<?php echo e(route('lists.trades.index')); ?>" type="button" class="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                                All trades
                            </a>
                        </div>
                    </div>
        ...
        <div class="flex-none w-full max-w-full mt-6">
            ...
            <div class="relative px-6 py-3 flex flex-col min-w-0 mb-6 break-words bg-gradient-to-br from-red-50 via-purple-50 to-gray-100 border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-lg bg-clip-border">
                ...
                <?php if($products->isEmpty()): ?>
                    <div class="mx-auto max-w-screen-sm text-center">
                        <img src="<?php echo e(asset('storage/svg/products_section.svg')); ?>" alt="Illustration of empty products section" class="mx-auto block w-80 h-80 mb-4">
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                    <div class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none dark:shadow-soft-dark-lg rounded-2xl bg-clip-border">
                                        <div class="relative">
                                            <a href="<?php echo e(route('products.show', $product->id)); ?>" wire:navigate class="block shadow-lg rounded-2xl">
                                                <img src="<?php echo e(asset('storage/' . $product->prod_picture)); ?>" alt="<?php echo e($product->prod_name); ?>" class="object-cover bg-center h-44 w-full shadow-soft-xl rounded-2xl" />
                                            </a>
                                        </div>
                                        <div class="flex-auto px-1 pt-6">
                                            <a href="<?php echo e(route('products.show', $product->id)); ?>" wire:navigate>
                                                <h5 class="dark:text-white"><?php echo e($product->prod_name); ?></h5>
                                            </a>
                                            <p class="relative z-10 mb-2 leading-normal text-transparent bg-gradient-to-tl from-gray-900 to-gray-800 text-sm bg-clip-text dark:text-white dark:opacity-80">
                                                ₱<?php echo e($product->prod_price); ?>

                                            </p>
                                            <p class="mb-6 leading-normal text-sm dark:text-white dark:opacity-60 text-truncate"><?php echo e($product->prod_description); ?></p>
                                            <div class="flex items-center justify-between">
                                                <a href="<?php echo e(route('products.show', $product->id)); ?>" wire:navigate class="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l rounded-lg shadow-none cursor-pointer leading-pro ease-soft-in text-xs hover:scale-102 active:shadow-soft-xs tracking-tight-soft border-fuchsia-500 text-fuchsia-500 hover:border-fuchsia-500 hover:bg-transparent hover:text-fuchsia-500 hover:opacity-75 hover:shadow-none active:bg-fuchsia-500 active:text-white active:hover:bg-transparent active:hover:text-fuchsia-500">
                                                    View product
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="relative px-6 py-3 flex flex-col min-w-0 mb-6 break-words bg-gradient-to-br from-red-50 via-purple-50 to-gray-100 border-0 dark:bg-gray-950 dark:shadow-soft-dark-xl shadow-soft-xl rounded-lg bg-clip-border">
                ...
                <?php if($posts->isEmpty()): ?>
                    <div class="mx-auto max-w-screen-sm text-center">
                        <img src="<?php echo e(asset('storage/svg/post_section.svg')); ?>" alt="Illustration of empty posts section" class="mx-auto block w-80 h-80 mb-4">
                                ...
                                <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                    <div class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none dark:shadow-soft-dark-lg rounded-2xl bg-clip-border">
                                        <?php if($post->post_picture): ?>
                                            <div class="relative">
                                                <a class="block shadow-lg rounded-2xl">
                                                    <img src="<?php echo e(asset('storage/' . $post->post_picture)); ?>" alt="<?php echo e($post->post_title); ?>" class="object-cover bg-center h-44 w-full shadow-soft-xl rounded-2xl" />
                                                </a>
                                            </div>
                                        <?php else: ?>
                                            <div class="relative flex items-center justify-center overflow-hidden rounded-2xl bg-cover bg-center h-44 shadow-soft-xl">
                                        ...
                                        <?php endif; ?>
                                        <div class="flex-auto px-1 pt-6">
                                            <a href="<?php echo e(route('posts.show', $post->id)); ?>" wire:navigate>
                                                <h5 class="dark:text-white"><?php echo e($post->post_title); ?></h5>
                                            </a>
                                            <p class="relative z-10 mb-2 leading-normal text-transparent bg-gradient-to-tl from-gray-900 to-gray-800 text-sm bg-clip-text dark:text-white dark:opacity-80">
                                                <?php echo e($post->post_list_type); ?>

                                            </p>
                                            <p class="mb-6 leading-normal text-sm dark:text-white dark:opacity-60 text-truncate"><?php echo nl2br(e($post->post_content)); ?></p>
                                            <div class="flex items-center justify-between">
                                                <a href="<?php echo e(route('posts.show', $post->id)); ?>" wire:navigate class="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl rounded-lg shadow-none cursor-pointer leading-pro ease-soft-in text-xs hover:scale-102 active:shadow-soft-xs tracking-tight-soft border-fuchsia-500 text-fuchsia-500 hover:border-fuchsia-500 hover:bg-transparent hover:text-fuchsia-500 hover:opacity-75 hover:shadow-none active:bg-fuchsia-500 active:text-white active:hover:bg-transparent active:hover:text-fuchsia-500">
                                                    View post
                                                </a>
                                            </div>
                                        </div>
...
<?php echo $__env->make('users.layouts.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ZPPSU-E-Marketplace\resources\views/users/home.blade.php ENDPATH**/ ?>