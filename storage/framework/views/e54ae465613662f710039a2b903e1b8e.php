...
<head>
    ...
    <title>
        ...
        <?php elseif(Route::currentRouteName() == 'login'): ?>
    ...
    <div id="app">
        <nav class="backdrop-filter backdrop-blur-lg bg-opacity-40 bg-white border-b border-gray-200 fixed left-0 right-0 top-0 z-50 dark:bg-gray-800 dark:backdrop:filter dark:backdrop-blur-lg dark:bg-opacity-40 dark:border-gray-700">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-2">
                <a href="<?php echo e(url('/')); ?>" wire:navigate class="flex items-center p-3 rounded-md space-x-3 rtl:space-x-reverse hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-300 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                ...
                <div class="flex md:order-2">
                    ...
                    <div>
                        <?php if(Route::currentRouteName() == 'register'): ?>
                            <a class="px-4 py-2 bg-gradient-to-br from-red-600 to-orange-400 hover:bg-gradient-to-bl text-gray-50 rounded-xl flex items-center justify-center gap-2" href="<?php echo e(route('login')); ?>" wire:navigate>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M3 3a1 1 0 011 1v12a1 1 0 11-2 0V4a1 1 0 011-1zm7.707 3.293a1 1 0 010 1.414L9.414 9H17a1 1 0 110 2H9.414l1.293 1.293a1 1 0 01-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0z" clip-rule="evenodd" />
                                </svg>
                                <span class="text-center">Login</span>
                            </a>
                        <?php elseif(Route::currentRouteName() == 'welcome'): ?>
                            <a class="px-4 py-2 bg-gradient-to-br from-red-600 to-orange-400 hover:bg-gradient-to-bl text-gray-50 rounded-xl flex items-center justify-center gap-2" href="<?php echo e(route('login')); ?>" wire:navigate>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M3 3a1 1 0 011 1v12a1 1 0 11-2 0V4a1 1 0 011-1zm7.707 3.293a1 1 0 010 1.414L9.414 9H17a1 1 0 110 2H9.414l1.293 1.293a1 1 0 01-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0z" clip-rule="evenodd" />
                                </svg>
                        ...
                        <?php elseif(Route::currentRouteName() == 'login'): ?>
                            <a class="px-4 py-2 bg-gradient-to-br from-red-600 to-orange-400 hover:bg-gradient-to-bl text-gray-50 rounded-xl flex items-center justify-center gap-2" href="<?php echo e(route('register')); ?>" wire:navigate>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M3 3a1 1 0 011 1v12a1 1 0 11-2 0V4a1 1 0 011-1zm7.707 3.293a1 1 0 010 1.414L9.414 9H17a1 1 0 110 2H9.414l1.293 1.293a1 1 0 01-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0z" clip-rule="evenodd" />
                                </svg>
...
<?php /**PATH C:\xampp\htdocs\ZPPSU-E-Marketplace\resources\views/layouts/nav.blade.php ENDPATH**/ ?>