            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex justify-between items-center px-4 py-3 hover:bg-gray-50 hover:rounded-md">
                    <div class="flex items-center gap-3">
                        ...
                        <a href="<?php echo e($result['url']); ?>" wire:navigate class="block text-gray-800">
                            <div class="font-semibold"><?php echo e($result['title']); ?></div>
                            <div class="text-sm text-gray-600 truncate"><?php echo e($result['description']); ?></div>
                        </a>
                    </div>
                    <button
                        type="button"
                        wire:click.prevent="removeResult(<?php echo e($loop->index); ?>)"
...
<?php /**PATH C:\xampp\htdocs\ZPPSU-E-Marketplace\resources\views/livewire/lists/search.blade.php ENDPATH**/ ?>